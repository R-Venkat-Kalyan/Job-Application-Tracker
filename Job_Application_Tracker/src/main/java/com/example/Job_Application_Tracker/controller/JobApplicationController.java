...
public class JobApplicationController {
    ...
    public String saveJobApplication(
            ...
            @RequestParam String platformUsed,
    ...
    public String findUserJobs(HttpSession session,Model model){
    	String email = (String) session.getAttribute("email");
    ...
    public ResponseEntity<byte[]> viewResume(@PathVariable String id) {
        ...
        if (jobOptional.isPresent()) {
            ...
            return ResponseEntity.ok()
                ...
                .contentType(MediaType.parseMediaType(job.getResumeType()))
    ...
    public String shortlistJob(@PathVariable String id, RedirectAttributes redirectAttributes) {
    ...
    public String rejectJob(@PathVariable String id, RedirectAttributes redirectAttributes) {
        jobRepo.findById(id).ifPresent(job -> {
    ...
    public String viewShortlistedJobs(HttpSession session, Model model) {
        String email = (String) session.getAttribute("email");
    ...
    @GetMapping("/rejected")
    public String viewRejectedJobs(HttpSession session, Model model) {
        String email = (String) session.getAttribute("email");
    ...
    public String viewNoUpdateJobs(HttpSession session, Model model) {
        String email = (String) session.getAttribute("email");
